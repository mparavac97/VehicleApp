...
// @ts-ignore
import ModalForm from './MakesModalForm.tsx';
import {Button} from 'reactstrap';
import React from 'react';

function MakesDataTable(props: { items: any[]; updateState?(vehicle: any): void; deleteItemFromState?(id: any): void }) {
